...
const CategoryBlock = ({
  ...
  const className = `caption-xs-medium whitespace-nowrap rounded-full px-xs py-xxxs min-w-[3.125rem] transition-colors duration-300 ease-in-out ${colorClassName}`;
